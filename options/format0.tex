...
% spave before and after equations
...
\newcommand{\fancyhfStyleOpening}[0]{
	...
	\fancyhead[R]{
		\begin{textblock*}{4.0cm}(78.0mm, -8.0mm)
			\includegraphics[height=1.1cm]{images/shared/DHBW-Logo.png}
		\end{textblock*}
		\begin{textblock*}{4.0cm}(120.0mm, -16.0mm)
			\includegraphics[height=2.0cm]{images/shared/Bosch-Logo-Kopfzeile.png}
		\end{textblock*}
	}
	\fancyfoot[L]{
		\tiny \fusszeile

...
\listingfile[caption=Beispiel Code in C, label=lst:c-code]{resources/codeSnippets/2CCode.c}

\listingfile[caption=Beispiel Code in Python, label=lst:python]{resources/codeSnippets/2PythonCode.py}
